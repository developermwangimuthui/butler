    ...
    new Chart(r,
        {
            ...
            options: {
                ...
                scales: {
                    xAxes: [{
                        display: !0, barPercentage: .75, categoryPercentage: .3,
                        gridLines: { color: "#f3f3f3", drawTicks: !1 },
                        scaleLabel: { display: !1, labelString: "Days" }
                    }],
                    yAxes: [{
                ...
                title: { display: !1, text: "Appointment Statistics" }
            },
            data: {
                labels: ["MON", "TUE", "WED", "THU", "FRI", "SAT", "SUN"],
                datasets: [{
                    type: "line", label: "Appointment",
